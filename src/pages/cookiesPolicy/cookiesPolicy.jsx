...
const CookiePolicy = () => {
  return (
    <div className="cookie-policy">
      ...
      <p>
        Esta política de cookies fue actualizada por última vez el octubre 25, 2023 y se aplica a los ciudadanos y residentes legales permanentes del Espacio Económico Europeo y Suiza.
      </p>
      <h2>1. Introducción</h2>
      <p>Nuestra web, https://paberater.de (en adelante: «la web») utiliza cookies y otras tecnologías relacionadas (para mayor comodidad, todas las tecnologías se denominan «cookies»). Las cookies también son colocadas por terceros a los que hemos contratado. En el siguiente documento te informamos sobre el uso de cookies en nuestra web.</p>
      ...
      <h2>7.1 Gestiona tus ajustes de consentimiento</h2>
