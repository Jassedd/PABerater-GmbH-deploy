        ...
        <>
            ...
            <section className="form_landing">
                <div className="frame-youtube">
                    <img
                        src={LandingImg}
                        className="pinedaImage"
                        alt="Pineda-Paberater"
                    />
                </div>
            ...
            <section className="first-stape">
                <div className="text_first-stape">
                    ...
                    <h4 className="first-text-landing">
                ...
                <article className="steps-landing">
                    <div className="steps-title">
                        <h2 className="steps-title">
                            El primer paso hacia tu crecimiento profesional{" "}
                            <br />
                            en Alemania, está a solo 30 min"
                        </h2>
                    </div>
                    <section className="landing-map">
                        <p className="text-landing-map1">
                    ...
                    <section className="landing-map">
                        ...
                        <p className="text-landing-map2">
                            Proceso ágil, transparente y confiable
                        </p>
                    </section>
                    <section className="landing-map">
                        <p className="text-landing-map3">
                            Oportunidades acorde <br />a tu perfil profesional
                        </p>
                    </section>
                </article>
                <article className="landing-contact">
                    ...
                    <div className="Figure-text-landing">
                        <p className="text-landing">
                            Tu pones el talento, <br /> nosotros nos encargamos
                            de lo demás
                        </p>
                    </div>
                </article>
            ...
            <section className="arowsImg">
                <section className="pay-landing">
                    ...
                    <h4 style={{ fontSize: "1.3rem", fontWeight: "600" }}>
                        Comienza tu proceso y paga en cómodas facilidades
                    </h4>
                    <p style={{ fontSize: "1.5rem" }}>
                        <br /> Elige el plan ideal para ti.
                        <br /> <br />
                        <span className="span-landing">A.</span> Inicia tu
                        proceso y paga el 50% a los quince días. Liquida 2 meses
                        después.
                        <br /> <br />
                        <span className="span-landing">B.</span> Pronto pago.
                        Pago en una exhibición y te descontamos{" "}
                        <span className="span-landing">100€.</span>
                    </p>
