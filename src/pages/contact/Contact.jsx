...
function Contact() {
    ...
    const phone = t("contactPage.phone");
    const location = t("contactPage.location");
    const email = t("contactPage.email");

    const seoTitle = t("contactPage.seoTitle");
    const seoDescription = t("contactPage.seoDescription");
    ...
    return (
        <main>
            ...
            <ScrollToTop />
            <PageBanner title={title} image={Contacto} />

            {/*       <section className="contact_section">
                <img
                    src={Contacto}
                    alt="contact-img"
                    className="banner_contact_img"
                />
                <div className="figure_contact">
                    <h1 className="title_img_contact">{title}</h1>
                </div>
            </section> */}
            <QuestionForm />
            ...
            <section className="Contact">
                <div className="info_contact">
                    <div className="contact-div">
                        ...
                        <p className="text_info_contact">{phone}</p>
                    </div>

                    <div className="contact-div">
                        <img src={EmailIcon} alt="" className="icons_contact" />
                        <p className="text_info_contact">{email}</p>
                    </div>

                    <div className="contact-div">
                        <img src={LocalIcon} alt="" className="icons_contact" />
                        <p className="text_info_contact">{location}</p>
                    </div>
                </div>
